          ...
          <div className="col-lg-6 col-md-12 col-sm-13 image-column ml_0 about__main-column">
            <div className="image_block">
              <div className="image-box p_relative">
                <div
                  className="aboutcard__text bg-white wow fadeInUp animated"
                  data-wow-delay="05ms"
                ...
                >
                  ...
                  <section className="aboutcard__buttons">
                    <div className="aboutcard__button-item">
                      <Link
                        href="/modalvideo"
                        prefetch={false}
                        className="aboutcard__button-link"
                      >
                        <Button
                          size="lg"
                          className="theme-btn-one aboutcard__button w-100"
                        >
